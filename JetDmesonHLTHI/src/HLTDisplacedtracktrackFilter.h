#ifndef HLTDisplacedtracktrackFilter_h
#define HLTDisplacedtracktrackFilter_h
...
class HLTDisplacedtracktrackFilter : public HLTFilter {

  public:
    explicit HLTDisplacedtracktrackFilter(const edm::ParameterSet&);
    ~HLTDisplacedtracktrackFilter();
