...
process.HLTtktkD0TagSequenceL3 = cms.Sequence( process.HLTIterativeTrackingForBTagIter02 + process.hltVerticesL3 )
...
process.HLT_PuAK4CaloJet80PlustktkD0_v1 =  cms.Path(process.HLTBeginSequence*process.hltL1sL1SingleJet16BptxAND*process.hltPrePuAK4CaloJet80 * process.hltPrePuAK4CaloJet80 * process.HLTPuAK4CaloJetsSequence * process.hltSinglePuAK4CaloJet80
                                                * process.HLTFastPrimaryVertexSequence
                                                * process.HLTtktkD0TagSequenceL3
                                                * process.dMesontktkTagger
                                                * process.HLTEndSequence
                                                )
...
process.HLTSchedule = cms.Schedule(process.HLT_PuAK4CaloJet80_v1,process.HLT_PuAK4CaloJet80PlusBJetCSV_v1,process.HLT_PuAK4CaloJet80PlusD0_v1,process.HLT_PuAK4CaloJet80PlustktkD0_v1 )
